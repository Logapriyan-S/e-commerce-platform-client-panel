    ...
    >
      <div className="relative bg-black bg-opacity-60 backdrop-blur-sm p-8 rounded-lg shadow-2xl w-full max-w-md">
        ...
        {successMessage ? (
          ...
          <>
            <h2 className="text-3xl font-bold mb-6 text-center text-white font-inter rounded-md">Register</h2>
            <form onSubmit={handleRegister} className="space-y-6">
              <input
                type="text"
                placeholder="Username"
                className="w-full px-4 py-3 bg-gray-700 text-white border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 font-inter"
                value={username}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-green-600 text-white py-3 rounded-md hover:bg-green-700 transition-colors font-semibold disabled:bg-green-400 font-inter"
              >
            ...
            <p className="text-sm mt-6 text-center text-gray-300 font-inter">
              ...
              <a href="/login" onClick={(e) => { e.preventDefault(); navigate('/login'); }} className="text-green-400 hover:underline">
                Login
              </a>
            </p>
          </>
